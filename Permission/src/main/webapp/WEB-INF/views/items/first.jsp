...
<%@ include file="/WEB-INF/views/items/tag.jsp"%>
<html>
<head>
<title>药品采购平台</title>
...
<%@ include file="/WEB-INF/views/items/common_css.jsp"%>
<%@ include file="/WEB-INF/views/items/common_js.jsp"%>
		...
		<DIV id="nav" class="easyui-accordion" border="false" fit="true">
			...
			<li><div>
					<a title="创建采购单" ref="1_1" href="#"
						rel="${baseurl}queryItems.action" icon="icon-log"><span
						class="icon icon-log">&nbsp;</span><span class="nav"><a href=javascript:addTab('创建采购单','${baseurl}queryItems.action')>商品查询</a></span></a>
				</div></li>
			<li><div>
					<a title="提交采购单" ref="1_1" href="#"
						rel="queryItems.action?type=1" icon="icon-log"><span
